...
import { Copy, Download, Check, ArrowLeft, ImageIcon } from "lucide-react";
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <p className="mt-1 text-sm text-muted">
              ...
              {event.photographer_name && ` · Photographer: ${event.photographer_name}`}
            </p>
          </div>
          ...
          <Card className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-2">memories collected so far</p>
            </div>
          </Card>
        </div>
